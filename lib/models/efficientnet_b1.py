...
class EfficientNet_B1(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('tf_efficientnet_b1.ns_jft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/efficientnet_b1.pth')
        # load_checkpoint(self.selected_feature_extractor, './efficientnet_b1.pth')
