...
class DaVit_Tiny(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('davit_tiny.msft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/davit_tiny.pth')
        # load_checkpoint(self.selected_feature_extractor, './davit_tiny.pth')
