...
class ConvNeXt_Base(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('convnext_base.fb_in22k_ft_in1k', features_only=True, out_indices=self.out_indices,pretrained=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/convnext_base.pth')
        # load_checkpoint(self.selected_feature_extractor, './convnext_base.pth')
