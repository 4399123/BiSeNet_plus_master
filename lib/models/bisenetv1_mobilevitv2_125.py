...
from .mobilevitv2_125 import MobileVitV2_125
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MobileVitV2_125()
        self.arm16 = AttentionRefinementModule(480, 256)
...
class BiSeNetV1_MobileVitV2_125(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_MobileVitV2_125, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_MobileVitV2_125(19)
    net.eval()
