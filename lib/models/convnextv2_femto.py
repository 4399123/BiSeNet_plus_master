...
class ConvNeXtV2_Femto(nn.Module):
    def __init__(self):
        super(ConvNeXtV2_Femto, self).__init__()
        self.out_indices = [1, 2, 3]
        self.selected_feature_extractor = timm.create_model('convnextv2_femto', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/convnextv2_femto.pth')
        # load_checkpoint(self.selected_feature_extractor, './convnextv2_femto.pth')
