...
from .efficientnetv2_b1 import EfficientNetV2_B1
...
class BiSeNetV1_EfficientNetV2_B1(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_EfficientNetV2_B1, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNetV2_B1(19)
    net.eval()
