...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = GerNet()
        self.arm16 = AttentionRefinementModule(640, 256)
        self.arm32 = AttentionRefinementModule(2560, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(2560, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_GerNet(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_GerNet, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
