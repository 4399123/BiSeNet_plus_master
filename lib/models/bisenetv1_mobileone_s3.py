...
from .mobileone_s3 import MobileOne_S3
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = MobileOne_S3()
        self.arm16 = AttentionRefinementModule(768, 256)
...
class BiSeNetV1_MobileOne_S3(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_MobileOne_S3, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
