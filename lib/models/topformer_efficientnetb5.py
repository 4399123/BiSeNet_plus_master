...
class TopFormer_EfficientNet_B5(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        ...
        self.decode_head = Head(c=384,n_classes=n_classes)
...
if __name__ == '__main__':
    topf = TopFormer_EfficientNet_B5()
