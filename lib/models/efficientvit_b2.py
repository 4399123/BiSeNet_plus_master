...
class EfficientVit_B2(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('efficientvit_b2.r256_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientvit_b2.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientvit_b2.pth')
