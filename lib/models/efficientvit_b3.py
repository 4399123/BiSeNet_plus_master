...
class EfficientVit_B3(nn.Module):
    def __init__(self):
        super(EfficientVit_B3, self).__init__()
        self.out_indices = [1,2,3]
        self.selected_feature_extractor = timm.create_model('efficientvit_b3.r256_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/efficientvit_b3.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/efficientvit_b3.pth')
