...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv_avg = ConvBNReLU(384, 256, ks=1, stride=1, padding=0,act=False)
...
class BiSeNetV1_EfficientNet_B3_SE(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_SE, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_SE(19)
    net.eval()
