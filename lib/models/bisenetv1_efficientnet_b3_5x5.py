...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv_head32 = ConvBNReLU(256, 256, ks=5, stride=1,groups=256, padding=2)
        self.conv_head16 = ConvBNReLU(256, 256, ks=5, stride=1, groups=256,padding=2)
...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv2 = ConvBNReLU(128, 128, ks=5, stride=2, groups=128,padding=2)
        self.conv3 = ConvBNReLU(128, 128, ks=5, stride=2, groups=128,padding=2)
...
class BiSeNetV1_EfficientNet_B3_5x5(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_5x5, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_5x5(19)
    net.eval()
