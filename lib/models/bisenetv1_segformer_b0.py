...
try:
    from .segformer_b0_backbone import SegFormer_B0
except:
    from segformer_b0_backbone import SegFormer_B0
...
class BiSeNetV1_SegFormer_B0(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_SegFormer_B0, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
