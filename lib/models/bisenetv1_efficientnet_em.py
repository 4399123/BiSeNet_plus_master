...
from .efficientnet_em import EfficientNet_EM
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = EfficientNet_EM()
        self.arm16 = AttentionRefinementModule(144, 256)
        self.arm32 = AttentionRefinementModule(192, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(192, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_EfficientNet_EM(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_EM, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_EM(19)
    net.eval()
