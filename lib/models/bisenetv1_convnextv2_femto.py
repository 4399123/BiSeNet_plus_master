...
from .convnextv2_femto import ConvNeXtV2_Femto
...
class BiSeNetV1_ConvNeXtV2_Femto(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_ConvNeXtV2_Femto, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_ConvNeXtV2_Femto(19)
    # net.cuda()
    net.eval()
