...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv2 = ConvBNReLU(128, 128, ks=7, stride=2, groups=128,padding=3)
        self.conv3 = ConvBNReLU(128, 128, ks=7, stride=2, groups=128,padding=3)
...
class BiSeNetV1_EfficientNet_B3_L(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_L, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_L(19)
    net.eval()
