...
class EfficientNet_EM(nn.Module):
    def __init__(self):
        super(EfficientNet_EM, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('efficientnet_em.ra2_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/efficientnet_em.pth')
        # load_checkpoint(self.selected_feature_extractor, './efficientnet_em.pth')
