...
class GlobalResponseNorm(nn.Module):
    ...
    """
    def __init__(self, dim, eps=1e-6, channels_last=False):
        super().__init__()
        self.eps = eps
        if channels_last:
...
class AttentionRefinementModule(nn.Module):
    def __init__(self, in_chan, out_chan, *args, **kwargs):
        ...
        self.grn = GlobalResponseNorm(out_chan)
        self.init_weight()
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = EfficientNet_B2()
        self.arm16 = AttentionRefinementModule(120, 256)
        self.arm32 = AttentionRefinementModule(352, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(352, 256, ks=1, stride=1, padding=0)
...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.grn2 = GlobalResponseNorm(128)
        self.grn3=GlobalResponseNorm(256)
        self.init_weight()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B2_GRN(19)
    net.eval()
