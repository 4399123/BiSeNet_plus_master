...
try:
    from .segformer_b1_backbone import SegFormer_B1
except:
    from segformer_b1_backbone import SegFormer_B1
...
class BiSeNetV1_SegFormer_B1(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_SegFormer_B1, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
