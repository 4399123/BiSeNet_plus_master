...
from .edgenext_small import EdgeNeXt_Small
...
class BiSeNetV1_EdgeNeXt(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_EdgeNeXt, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
