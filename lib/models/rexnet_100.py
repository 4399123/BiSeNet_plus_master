...
class ReXNet_100(nn.Module):
    def __init__(self):
        super(ReXNet_100, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('rexnet_100.nav_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/rexnet_100.pth')
