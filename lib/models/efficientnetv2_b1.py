...
class EfficientNetV2_B1(nn.Module):
    def __init__(self):
        super(EfficientNetV2_B1, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('tf_efficientnetv2_b1.in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/efficientnetv2_b1.pth')
