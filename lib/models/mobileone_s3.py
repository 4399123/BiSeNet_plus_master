...
class MobileOne_S3(nn.Module):
    def __init__(self):
        super(MobileOne_S3, self).__init__()
        self.out_indices = [2,3,4]
        self.selected_feature_extractor = timm.create_model('mobileone_s3', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/premodels/mobileone_s3.pth')
        # load_checkpoint(self.selected_feature_extractor, '../premodels/mobileone_s3.pth')
