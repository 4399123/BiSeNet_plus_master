...
class EfficientFormerV2(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('efficientformerv2_s1.snap_dist_in1k', features_only=True, out_indices=self.out_indices,pretrained=False,
                                                            img_size=512,distillation=True)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/efficientformerv2_s1.pth')
        load_checkpoint(self.selected_feature_extractor, './efficientformerv2_s1.pth')
    def forward(self, x):
