...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.arm16 = AttentionRefinementModule(136, 128)
        self.arm32 = AttentionRefinementModule(384, 128)
        self.conv_head32 = ConvBNReLU(128, 128, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(128, 128, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(384, 128, ks=1, stride=1, padding=0,act=False)
...
class BiSeNetV1_EfficientNet_Lite3_Slim(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_Lite3_Slim, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_Lite3_Slim(19)
    net.eval()
