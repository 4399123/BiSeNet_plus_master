...
class LCNet_300(nn.Module):
    def __init__(self):
        super(LCNet_300, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('lcnet_300', features_only=True, out_indices=self.out_indices,pretrained=False)
