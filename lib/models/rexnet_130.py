...
class ReXNet_130(nn.Module):
    def __init__(self):
        super(ReXNet_130, self).__init__()
        self.out_indices = [2, 3,4]
        self.selected_feature_extractor = timm.create_model('rexnet_130.nav_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/rexnet_130.pth')
        # load_checkpoint(self.selected_feature_extractor, './rexnet_130.pth')
