...
from .davit_small import DaVit_Small
...
class BiSeNetV1_DaVit_Small(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_DaVit_Small, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
