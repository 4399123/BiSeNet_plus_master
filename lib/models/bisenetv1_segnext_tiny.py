...
try:
    from .segnext_tiny_backbone import SegNeXt_Tiny
except:
    from segnext_tiny_backbone import SegNeXt_Tiny
...
class BiSeNetV1_SegNeXt_Tiny(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_SegNeXt_Tiny, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
