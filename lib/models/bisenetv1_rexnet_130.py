...
from .rexnet_130 import ReXNet_130
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = ReXNet_130()
        self.arm16 = AttentionRefinementModule(167, 256)
        self.arm32 = AttentionRefinementModule(240, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(240, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_ReXNet_130(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_ReXNet_130, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
