...
class FastVit_SA36(nn.Module):
    def __init__(self):
        super(FastVit_SA36, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('fastvit_sa36', features_only=True, out_indices=self.out_indices,pretrained=True)
