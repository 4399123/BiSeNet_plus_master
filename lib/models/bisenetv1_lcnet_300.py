...
from .lcnet_300 import LCNet_300
...
class BiSeNetV1_LCNet_300(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_LCNet_300, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
