...
class EdgeNeXt_Small(nn.Module):
    def __init__(self):
        super(EdgeNeXt_Small, self).__init__()
        ...
        load_checkpoint(self.selected_feature_extractor, '../lib/models/edgenext_small.pth')
        # load_checkpoint(self.selected_feature_extractor, './edgenext_small.pth')
