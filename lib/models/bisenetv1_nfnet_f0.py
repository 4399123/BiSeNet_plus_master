...
class BiSeNetV1_NFNet_F0(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_NFNet_F0, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
