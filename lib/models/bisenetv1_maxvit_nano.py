...
from .maxvit_nano import MaxVit_Nano
...
class BiSeNetV1_MaxVit_Nano(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_MaxVit_Nano, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
