...
class SegHead(nn.Module):
    ...
    def __init__(self, decode_chans):
        ...
        self.sppm = SPPFModule(512, decode_chans[0])
        self.uafm1 = UAFM(256, decode_chans[0], decode_chans[1])
        self.uafm2 = UAFM(128, decode_chans[1], decode_chans[2])
...
class PPLiteSeg_FastVit_SA24(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(PPLiteSeg_FastVit_SA24,self).__init__()
