...
from .convnextv2_pico import ConvNeXtV2_Pico
...
class BiSeNetV1_ConvNeXtV2_Pico(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_ConvNeXtV2_Pico, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_ConvNeXtV2_Pico(19)
    # net.cuda()
    net.eval()
