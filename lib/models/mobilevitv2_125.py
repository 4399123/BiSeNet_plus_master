...
class MobileVitV2_125(nn.Module):
    def __init__(self):
        super(MobileVitV2_125, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('edgenext_small.usi_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)
        # load_checkpoint(self.selected_feature_extractor, '../lib/models/mobilevitv2_125.pth')
        # load_checkpoint(self.selected_feature_extractor, './mobilevitv2_125.pth')
