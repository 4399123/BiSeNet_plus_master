...
class ECA_NFNet_L0(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('eca_nfnet_l0', features_only=True, out_indices=self.out_indices,pretrained=False)

        # load_checkpoint(self.selected_feature_extractor, '../lib/models/eca_nfnet_l0.pth')
        # load_checkpoint(self.selected_feature_extractor, './eca_nfnet_l0.pth')
