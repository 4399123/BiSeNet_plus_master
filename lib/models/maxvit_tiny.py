...
class MaxVit_Tiny(nn.Module):
    def __init__(self):
        ...
        self.selected_feature_extractor = timm.create_model('maxvit_tiny_rw_224.sw_in1k', features_only=True, out_indices=self.out_indices,pretrained=False,img_size=512)
