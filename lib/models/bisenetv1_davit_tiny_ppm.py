...
from .davit_tiny import DaVit_Tiny
...
class BiSeNetV1_DaVit_Tiny_PPM(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_DaVit_Tiny_PPM, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_DaVit_Tiny_PPM(19)
    net.eval()
