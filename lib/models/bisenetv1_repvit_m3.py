...
from .repvit_m3 import RepVit_M3
...
class BiSeNetV1_RepVit_M3(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_RepVit_M3, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
