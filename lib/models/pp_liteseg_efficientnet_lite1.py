...
class SegHead(nn.Module):
    ...
    def __init__(self, decode_chans):
        ...
        self.sppm = SPPFModule(320, decode_chans[0])
        self.uafm1 = UAFM(112, decode_chans[0], decode_chans[1])
        self.uafm2 = UAFM(40, decode_chans[1], decode_chans[2])
...
class PPLiteSeg_EfficientNet_Lite1(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(PPLiteSeg_EfficientNet_Lite1,self).__init__()
    ...
    def forward(self, x):
        with autocast(enabled=self.use_fp16):
            ...
            # x=self.classifer[0](head_out[0])
            # feat_out=F.interpolate(x, (h, w), mode='bilinear', align_corners=False)
...
if __name__ == "__main__":
    net = PPLiteSeg_EfficientNet_Lite1(19)
    net.eval()
