...
from .efficientnet_b3_pruned import EfficientNet_B3_Pruned
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = EfficientNet_B3_Pruned()
...
class BiSeNetV1_EfficientNet_B3_Pruned(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_Pruned, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_Pruned(19)
    net.eval()
