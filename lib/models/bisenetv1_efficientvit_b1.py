...
from .efficientvit_b1 import EfficientVit_B1
...
class BiSeNetV1_EfficientVit_B1(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientVit_B1, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientVit_B1(19)
    net.eval()
