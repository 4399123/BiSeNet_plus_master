...
from .fastvit_sa36 import FastVit_SA36
...
class BiSeNetV1_FastVit_SA36(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_FastVit_SA36, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
