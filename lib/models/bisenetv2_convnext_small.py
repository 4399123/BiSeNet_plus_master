...
class SegmentBranch(nn.Module):
    ...
    def __init__(self):
        ...
        self.arm4 = AttentionRefinementModule(96, 16)
        self.arm8 = AttentionRefinementModule(192, 32)
        self.arm16 = AttentionRefinementModule(384, 64)
    ...
    def forward(self, x):
        ...
        feat21, feat31, feat41, feat5_41 = self.resnet(x)
        feat21=self.arm4(feat21)
        feat31 = self.arm8(feat31)
        feat41 = self.arm16(feat41)
        feat5_41 = self.arm32(feat5_41)
        feat5_51 = self.S5_5(feat5_41)
...
class BiSeNetV2(nn.Module):
    ...
    def load_pretrain(self):
        ...
        state =torch.load('../lib/models/backbone_v2.pth')
