...
from .efficientnet_b5_topformer import EfficientNet_B5
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = EfficientNet_B5()
        self.arm16 = AttentionRefinementModule(176, 256)
...
class BiSeNetV1_EfficientNet_B5(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B5, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B5(19)
    net.eval()
