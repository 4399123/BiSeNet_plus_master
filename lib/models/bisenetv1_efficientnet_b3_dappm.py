...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.dasppm = DAPPM(inplanes=384, branch_planes=96, outplanes=256)
...
class BiSeNetV1_EfficientNet_B3_DAPPM(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_DAPPM, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_DAPPM(19)
    net.eval()
