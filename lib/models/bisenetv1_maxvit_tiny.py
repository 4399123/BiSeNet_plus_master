...
from .maxvit_tiny import MaxVit_Tiny
...
class BiSeNetV1_MaxVit_Tiny(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_MaxVit_Tiny, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
