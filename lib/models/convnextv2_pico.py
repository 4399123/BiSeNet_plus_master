...
class ConvNeXtV2_Pico(nn.Module):
    def __init__(self):
        super(ConvNeXtV2_Pico, self).__init__()
        self.out_indices = [1, 2, 3]
        self.selected_feature_extractor = timm.create_model('convnextv2_pico.fcmae_ft_in1k', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/convnextv2_pico.pth')
        # load_checkpoint(self.selected_feature_extractor, './convnextv2_pico.pth')
