...
from .vovnet57b import VOVNet57B
...
class BiSeNetV1_VOVNet57B(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_VOVNet57B, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
