...
class BiSeNetOutput(nn.Module):
    ...
    def __init__(self, in_chan, mid_chan, n_classes, up_factor=32, *args, **kwargs):
        ...
        out_chan = n_classes
        self.conv = ConvBNReLU(in_chan, mid_chan, ks=5, stride=1, padding=2)
...
class BiSeNetV1_EfficientNet_B3_SA(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_SA, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_SA(19)
    net.eval()
