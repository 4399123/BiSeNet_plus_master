...
from .fbnetv3_d import FBNetV3_D
...
class BiSeNetV1_FBNetV3_D(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=True, *args, **kwargs):
        super(BiSeNetV1_FBNetV3_D, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
