...
from .bricks import DepthwiseConv,DownSampling,DropPath
...
class MSCAN(nn.Module):
    ...
    def init_weight(self):
        ...
        # checkpoint = torch.load('../premodels/mscan_t.pth',map_location='cpu')
...
class SegNeXt_Tiny_V2(nn.Module):
    ...
    def __init__(
        ...
        super(SegNeXt_Tiny_V2, self).__init__()
...
if __name__ == "__main__":
    net = SegNeXt_Tiny_V2(n_classes=9)
    net.eval()
    in_ten = torch.randn(2, 3, 224, 224).to('cpu')
    aa = net(in_ten)
    # print(aa.shape)