...
class RepVit_M3(nn.Module):
    def __init__(self):
        super(RepVit_M3, self).__init__()
        self.out_indices = [1, 2,3]
        self.selected_feature_extractor = timm.create_model('repvit_m3', features_only=True, out_indices=self.out_indices,pretrained=False)

        load_checkpoint(self.selected_feature_extractor, '../lib/models/repvit_m3.pth')
        # load_checkpoint(self.selected_feature_extractor, './repvit_m3.pth')
