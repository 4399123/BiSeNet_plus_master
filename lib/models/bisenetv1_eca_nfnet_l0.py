...
from .eca_nfnet_l0 import ECA_NFNet_L0
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.resnet = ECA_NFNet_L0()
        self.arm16 = AttentionRefinementModule(1536, 256)
        self.arm32 = AttentionRefinementModule(2304, 256)
        self.conv_head32 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(256, 256, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(2304, 256, ks=1, stride=1, padding=0)
...
class BiSeNetV1_ECA_NFNet_L0(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_ECA_NFNet_L0, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
