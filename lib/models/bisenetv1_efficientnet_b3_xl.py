...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv_head32 = ConvBNReLU(256, 256, ks=7, stride=1,groups=256, padding=3)
        self.conv_head16 = ConvBNReLU(256, 256, ks=7, stride=1, groups=256,padding=3)
...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv1 = ConvBNReLU(3, 128, ks=11, stride=2, padding=5)
        self.conv2 = ConvBNReLU(128, 128, ks=11, stride=2, groups=128,padding=5)
        self.conv3 = ConvBNReLU(128, 128, ks=11, stride=2, groups=128,padding=5)
...
class BiSeNetV1_EfficientNet_B3_XL(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_EfficientNet_B3_XL, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_B3_XL(19)
    net.eval()
