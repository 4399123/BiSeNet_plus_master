...
class BiSeNetOutput(nn.Module):
    ...
    def __init__(self, in_chan, mid_chan, n_classes, up_factor=32, *args, **kwargs):
        ...
        self.up =UpSample(n_chan=out_chan,factor=up_factor)
        self.init_weight()
...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.up32 = UpSample(n_chan=256)
        self.up16 = UpSample(n_chan=256)
...
class BiSeNetV1_EfficientNet_Lite3_Sub(nn.Module):

    def __init__(self, n_classes, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(BiSeNetV1_EfficientNet_Lite3_Sub, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    net = BiSeNetV1_EfficientNet_Lite3_Sub(19)
    net.eval()
