...
from .fastvit_sa24_topformer import FastVit_SA24
import numpy as np
...
class TopFormer_FastVit_SA24(nn.Module):
    def __init__(self, n_classes=5, aux_mode='train',use_fp16=False, *args, **kwargs):
        super(TopFormer_FastVit_SA24,self).__init__()
