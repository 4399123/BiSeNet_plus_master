...
parse.add_argument('--config', dest='config', type=str,
        default='../configs/../configs/bisenetv1_blueface_fastvit_sa24.py',)
parse.add_argument('--weight-path', dest='weight_pth', type=str,
        default='../pt/X/v1_blueface_fastvit_sa24.pt')
parse.add_argument('--outpath', dest='out_pth', type=str,
        default='./onnx/fastvit_sa24.onnx')
parse.add_argument('--ousmitpath', dest='outsmi_pth', type=str,
        default='./onnx/fastvit_sa24-smi.onnx')
